...
<html lang="en">
<head>
    <title>Fans Studio Admin - Dashboard</title>
        ...
        <div class="headerbar">
            ...
            <div class="headerbar-left">
                <a href="<?php echo e(url('/admin')); ?>" class="logo">
                    <img alt="Logo" src="<?php echo e(asset('public/assets/images/logo.png')); ?>" />
                    <span>Fans Studio</span>
                </a>
            </div>
                        ...
                        <div class="dropdown-menu dropdown-menu-right profile-dropdown ">
                            ...
                            <div class="dropdown-item noti-title">
                                <h5 class="text-overflow">
                                    <small>Hello, <?php echo isset(Auth::guard('admin')->user()->name) ? Auth::guard('admin')->user()->name : 'Fans Studio';?></small>
                                </h5>
                            </div>
...
<?php /**PATH /home/appmantr/public_html/fansstudio/resources/views/admin/common/header.blade.php ENDPATH**/ ?>