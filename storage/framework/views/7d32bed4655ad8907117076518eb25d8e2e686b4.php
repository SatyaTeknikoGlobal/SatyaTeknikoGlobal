          ...
          <div class="card mb-3">
            <div class="card-header">
              ...
              <span class="pull-right">
                <a href="<?php echo e(route('admin.events.add', ['back_url'=>$BackUrl])); ?>" class="btn btn-primary btn-sm"><i class="fas fa-user-plus" aria-hidden="true"></i> Add New Events</a>
              </span>
            </div>
...
<script>
  ...
  var table = $('#dataTable').DataTable({
   ...
   processing: true,
   serverSide: true,
   ajax: '<?php echo e(route("admin.events.get_events")); ?>',
   columns: [
   { data: 'id', name: 'id' },
  //    {
  //   "render": function() {
...
<script>
        ...
        </script><?php /**PATH /home/appmantr/public_html/fansstudio/resources/views/admin/events/index.blade.php ENDPATH**/ ?>