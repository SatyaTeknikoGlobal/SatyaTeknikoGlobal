											...
											<tr>
												...
												<td>
													...
													<td>
														...
														<a href="<?php echo e(route($routeName.'.galleries.delete', $gallery->id)); ?>" onclick="return confirm('Are You Want To Delete')"><i class="fa fa-trash"></i></a>
													</td>
												</tr>
												<?php
											}}
...
<?php /**PATH /home/appmantr/public_html/fansstudio/resources/views/admin/galleries/index.blade.php ENDPATH**/ ?>