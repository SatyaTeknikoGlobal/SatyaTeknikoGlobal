        ...
        <div class="left main-sidebar">
            ...
            <div class="sidebar-inner leftscroll">
                ...
                <div id="sidebar-menu">
                    ...
                    <ul>
                        <li class="submenu">
                            <a class="<?php if($url == $baseurl.'/'.$ADMIN_ROUTE_NAME) echo "active"?>" href="{{url('/admin')}}">
                                <i class="fas fa-bars"></i>
                                <span> Dashboard </span>
                            </a>
                        </li>

                        @if(CustomHelper::isAllowedModule('influencers'))
                        <li class="submenu">
                            <a href="{{ route($ADMIN_ROUTE_NAME.'.influencers.index') }}" class="<?php if($url == $baseurl.'/admin/influencers') echo "active"?>">
                        ...
                        <li class="submenu">
                            ...
                            <ul class="list-unstyled">
                                ...
                                <li>
                                    <a href="{{ route($ADMIN_ROUTE_NAME.'.subscription.users_list') }}" <?php if($url == $baseurl.'/admin/subscription/users_list') echo "active"?>>Subscribed User</a>
                                </li>
                            </ul>
                        </li>
                        ...
                        <li class="submenu">
                         ...
                         @endif
                          ...
                          <li class="submenu">
                            <a href="{{url('admin/logout')}}" class="<?php if($url == $baseurl.'/admin/logout') echo "active"?>">
