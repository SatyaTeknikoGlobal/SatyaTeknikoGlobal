...
class CustomHelper{
 ...
 public static function getMerchantRouteName(){
        $MERCHANT_ROUTE_NAME = config('custom.MERCHANT_ROUTE_NAME');

        if(empty($MERCHANT_ROUTE_NAME)){
            $MERCHANT_ROUTE_NAME = 'merchant';
        }

        return $MERCHANT_ROUTE_NAME;
    }
